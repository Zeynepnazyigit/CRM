...
namespace Business
{
    ...
    public static class IOC
    {
        ...
        public static IServiceCollection AddCustomServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            // IServiceCollection serviceCollection = services.AddScoped<ILeadService, LeadService>();

            IServiceCollection serviceDesc = services.AddScoped<ILeadService, LeadService>();
